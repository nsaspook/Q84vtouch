...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ha_canfd: ${OBJECTFILES}
	...
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/ha_canfd ${OBJECTFILES} ${LDLIBSOPTIONS} -s

${OBJECTDIR}/_ext/5c0/ha_canfd.o: ../ha_canfd.c
	${MKDIR} -p ${OBJECTDIR}/_ext/5c0
	${RM} "$@.d"
	$(COMPILE.c) -O3 -s `pkg-config --cflags libcjson`   -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5c0/ha_canfd.o ../ha_canfd.c
