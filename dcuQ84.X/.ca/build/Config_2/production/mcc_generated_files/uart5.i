...
# 52 "mcc_generated_files/uart5.c" 2
# 64 "mcc_generated_files/uart5.c"
static volatile uint8_t uart5TxHead = 0;
static volatile uint8_t uart5TxTail = 0;
static volatile uint8_t uart5TxBuffer[32];
...
void __attribute__((picinterrupt(("irq(U5TX),base(8)")))) UART5_tx_vect_isr()
{
...
void __attribute__((picinterrupt(("irq(U5RX),base(8)")))) UART5_rx_vect_isr()
{
